...
I made sure used proper indentation and comments in your CSS code to improve readability.
...
In the process of building the webpage, I learnt how to use flexbox and how to add height and width to my image.
i also found out a website to generate colors for websites. You should check it out. The is attached above.
